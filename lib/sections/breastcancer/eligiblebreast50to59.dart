...
class eligiblebreast50to59 extends StatefulWidget {
  const eligiblebreast50to59({Key? key}) : super(key: key);

  @override
  State<eligiblebreast50to59> createState() => _eligiblebreast50to59State();
}

class _eligiblebreast50to59State extends State<eligiblebreast50to59> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("BREAST CANCER SCREENING FOR\nWOMEN NOT AT INCREASED RISK",
        style: TextStyle(
            fontSize: 16,
          ),),
